...
news_url = f'{domain}/News2022.html' # Страница нашего НИИ, посвящённой новостям 2022 года
tags_lst = [['Меню сайта', domain, 'ul', 'side', 'a'],  # Группа тегов для меню сайта
            ...
            ['Новости 2022 года', news_url, 'div', 'pages', 'h3']]  # Группа тегов для новостей 2022 года
head_lst = [{tags_lst[0][0]: []},  # 'Меню сайта'
            {tags_lst[1][0]: []},  # 'Направления деятельности'
            {tags_lst[2][0]: []},  # 'Полезные ссылки'
            {tags_lst[3][0]: []}]  # 'Новости 2022 года'
